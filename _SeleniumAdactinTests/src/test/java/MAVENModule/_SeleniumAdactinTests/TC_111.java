...
public class TC_111 extends SeleniumTest {
	...
	public TC_111() {
		try {	
			...
			String excelFilePath = System.getProperty("user.dir") + Utils.getSettingFromFile("TC_111_TESTDATA_FILE");
	...
	public void test111() {
		try {
			//use soft assertions so that all 5 items can be tested if a test failure occurs
